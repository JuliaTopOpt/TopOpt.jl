...
function GESO(obj::Objective{<:Any, <:ComplianceFunction}, constr::Constraint{<:Any, <:VolumeFunction}; maxiter = 1000, tol = 0.001, p = 3., Pcmin = 0.6, Pcmax = 1., Pmmin = 0.5, Pmmax = 1., Pen = 3., sens_tol = tol/100, string_length = 4)
