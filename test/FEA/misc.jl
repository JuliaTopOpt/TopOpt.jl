...
using TopOpt.FEA:
    getcompliance, matrix_free_apply2f!, update_f!, MatrixFreeOperator, MatrixOperator
...
@testset "matrix_free_apply2f! function tests" begin
    ...
    @testset "matrix_free_apply2f! with varying density" begin
        ...
        matrix_free_apply2f!(
            f_full, elementinfo, M, vars_full, problem, penalty, xmin, false
        )
        ...
        matrix_free_apply2f!(
            f_reduced, elementinfo, M, vars_reduced, problem, penalty, xmin, false
        )
